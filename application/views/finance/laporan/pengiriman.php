      ...
      <div class="card card-info card-tabs">
        <div class="card-header p-0 pt-1">
          <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link active" id="rekap-tab" data-toggle="pill" href="#rekap" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true"> <i class="fas fa-truck"></i> Pengiriman</a>
            </li>
          </ul>
        </div>
        <!-- card -->
              ...
              <div class="card card-info">
                ...
                <div class="card-footer">
                  <button type="button" id="btn_rekap" class="btn btn-info">
                    <li class="fas fa-search"></li> Rekap Pengiriman
                  </button>
                  <button type="button" id="btn_detail" class="btn btn-success">
                    <li class="fas fa-search"></li> Detail Pengiriman
                  </button>
                </div>
              </div>
              <!-- /.card -->
          ...
          <div id="printableArea">
            ...
            <div class="card card-info d-none" id="card_detail">
              <div class="card-header">
                <h3 class="card-title">
                  <li class="fas fa-file-alt"></li> Detail Pengiriman
                </h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool " data-card-widget="maximize">
                    <i class="fas fa-expand"></i>
                  </button>
                  <a href="<?= base_url('finance/Laporan/pengiriman') ?>" class="btn btn-tool">
              ...
              <div class="card-body">
                ...
                <h4 class="text-center">Laporan Pengiriman </h4>
              ...
              <div class="row no-print">
                ...
                <div class="col-md-2">
                  ...
                  <a href="<?= base_url('finance/Laporan/pengiriman') ?>" class="btn btn-danger btn-sm float-right  mb-4">close</a>
                </div>
              </div>
            </div>
            <!-- /.card -->
            <div class="card card-info d-none" id="hasil_rekap">
              <div class="card-header">
                <h3 class="card-title">
                  <li class="fas fa-file-alt"></li> Rekap Pengiriman
                </h3>
                <div class="card-tools">
                  <button type="button" class="btn btn-tool " data-card-widget="maximize">
                    <i class="fas fa-expand"></i>
              ...
              <div class="card-body">
                ...
                <h4 class="text-center">Rekap Pengiriman </h4>
...
<script type="text/javascript">
  ...
  $("#btn_detail").click(function() {
    ...
    if (tgl == "" || id_toko == "" || id_toko == "all") {
      ...
      $.ajax({
        url: "<?php echo base_url('finance/Laporan/detail_pengiriman'); ?>",
        type: "GET",
        dataType: "json",
        data: {
          id_toko: id_toko,
  ...
  $("#btn_rekap").click(function() {
    ...
    $.ajax({
      url: "<?php echo base_url('finance/Laporan/rekap_pengiriman'); ?>",
      type: "GET",
      dataType: "json",
      data: data,
      success: function(data) {
