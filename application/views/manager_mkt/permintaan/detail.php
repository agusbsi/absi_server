          ...
          <div class="col-md-12">
           ...
           <div class="callout callout-info">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  Status : <?= status_permintaan($p->status) ?>
                </div>
              </div>
           </div>
            ...
            <div class="invoice p-3 mb-3">
              <!-- title row -->
              <div class="row">
              <h4><li class="fas fa-file-alt"></li> DETAIL PERMINTAAN</h4>
              </div>
              <!-- info row -->
              ...
              <div class="row no-print">
                ...
                <a href="<?=base_url('mng_mkt/Permintaan')?>" class="btn btn-danger float-right" style="margin-right: 5px;"><i class="fas fa-times-circle"></i> Close </a>
                </div>
              </div>
            </div>
            </div>
