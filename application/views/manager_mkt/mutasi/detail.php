<section class="content">
  <div class="container-fluid">
    <div class="card card-default">
      <form action="<?= base_url('mng_mkt/Mutasi/proses_simpan') ?>" method="post" id="form_mutasi">
        ...
        <div class="card-body">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td>
                    <input type="number" class="form-control form-control-sm qty-input" name="qty[]" value="<?= $d->qty ?>" max="<?= $d->stok ?>" data-max="<?= $d->stok ?>" readonly>
          ...
          <hr>
          <div class="form-group <?= $mutasi->status == 6 ? '' : 'd-none' ?>">
        ...
        <div class="card-footer">
          <?php if ($mutasi->status == 6) { ?>
            <div class="col-12">
              <a href="<?= base_url('mng_mkt/Mutasi') ?>" class="btn btn-danger float-right btn-sm" style="margin-left: 5px;"><i class="fas fa-times-circle"></i> Close </a>
          ...
          <?php } else { ?>
            ...
            <a href="<?= base_url('mng_mkt/Mutasi') ?>" class="btn btn-danger float-right btn-sm" style="margin-right: 5px;"><i class="fas fa-times-circle"></i> Close </a>
          <?php } ?>
        </div>
      </form>
    </div>
  ...
  $('.btn-delete').click(function(e) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url() ?>mng_mkt/Mutasi/hapus_item",
          method: "POST",
          data: {
            id: id
          },
