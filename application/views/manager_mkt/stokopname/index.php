                  ...
                  <tbody>
                    <tr>
                      ...
                      <?php if ($dd->nama_user == "")
                        ...
                        <td>
                          <a href="<?= base_url('mng_mkt/so/pdf/'.$dd->id) ?>" target = "_blank" class="btn btn-warning <?= ($dd->nama_user == "") ? 'd-none' : ''; ?> <?= ($dd->status_so == "1") ? 'd-none' : ''; ?>"><i class="fas fa-file-pdf"></i> Format SO</a>
                          <a href="<?= base_url('mng_mkt/so/hasil_so/'.$dd->id) ?>" target = "_blank" class="btn btn-success <?= ($dd->nama_user == "") ? 'd-none' : ''; ?> <?= ($dd->status_so == "0") ? 'd-none' : ''; ?>"><i class="fas fa-file-pdf"></i> Hasil SO</a>
                        </td>
                    </tr>
                      <?php $no++; ?>
                      <?php endforeach;?>
