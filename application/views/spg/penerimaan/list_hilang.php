<tr class="row-list_hilang">
	...
	<td class="aksi">
		<button type="button" class="btn btn-danger btn-sm" id="btn_hilang" data-nama-barang="<?= $this->input->post('id_produk') ?>"><i class="fa fa-trash"></i></button>
	</td>
</tr>