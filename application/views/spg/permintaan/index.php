      ...
      <div class="col-12">
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-file-alt"></i> List PO</h3>
          ...
          <div class="card-body">
            ...
            <div class="card-po-wrapper" id="cardPoList">
              <?php foreach ($list_permintaan as $dd) : ?>
                <div class="card-po">
                  ...
                  <a class="btn btn-primary btn-sm btn-block" href="<?= base_url('spg/permintaan/detail/' . $dd->id) ?>"><i class="fa fa-eye"></i> Detail</a>
                </div>
              <?php endforeach; ?>
            </div>
