                  ...
                  <div class="tab-pane fade show active" id="supervisor" role="tabpanel" >
                    <form class="form-horizontal"  method="post" action="<?= base_url('hrd/user/proses_approve') ?>">                 
                      ...
                      <div class="row no-print">
                        ...
                        <button type="submit" class="btn btn-success float-right"><i class="fas fa-check-circle"></i> Approve</button>
                        <a data-id="<?= $detail->id;?>"  class="btn btn-danger float-right mr-3 btn-nonaktif "><i class="fa fa-times-circle"></i> Tolak</a>
                          <?php } else {
