                ...
                <div class="card card-info">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="<?= base_url('leader/Stok/s_customer') ?>" type="button" class="btn btn-tool remove">
                    ...
                    <div class="card-body">
                        ...
                        <div class="no-print">
                            ...
                            <a href="<?= base_url('leader/Stok/s_customer') ?>" class="btn btn-danger btn-sm float-right mr-1 "> <i class="fa fa-times-circle"></i> Close</a>
