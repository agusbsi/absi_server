                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu" style="">
                                                        <a class="dropdown-item" href="<?= base_url('leader/Stok/detail_toko/' . $dd->id) ?>">Per Toko</a>
                                                        <a class="dropdown-item" href="<?= base_url('leader/Stok/detail_artikel/' . $dd->id) ?>">Per Artikel</a>
                                                    </div>
                                                </div>
                                            </td>
                                </tr>
