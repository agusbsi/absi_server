      ...
      <div class="col-12">
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">
              <li class="fas fa-file"></li> Permintaan Barang (PO)
            </h3>
                ...
                <tbody>
                  ...
                  foreach ($list_data as $dd) :
                    ...
                    <tr>
                      ...
                      <td class="text-center"><small><?= date('d-M-Y H:i:s', strtotime($dd->created_at)) ?></small></td>
                      <td class="text-center">
                        <?php if ($dd->status == 0) { ?>
                          <a class="btn btn-success btn-sm" href="<?= base_url('leader/permintaan/terima/' . $dd->id) ?>"><i class="fa fa-paper-plane"></i> Proses</a>
                        <?php } else { ?>
                          <a class="btn btn-primary btn-sm" href="<?= base_url('leader/permintaan/detail/' . $dd->id) ?>"><i class="fa fa-eye"></i> Detail</a>
                        <?php } ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
              ...
              <?php foreach ($list_data as $dd) : ?>
                <div class="card-po">
                  <div class="card-po-header">
                    <div class="card-po-number">PO: <?= $dd->id ?></div>
                  ...
                  <div class="card-po-info">
                    ...
                    <div><?= status_permintaan($dd->status); ?></div>
                  </div>
                  <?php if ($dd->status == 0) { ?>
                    <a class="btn btn-success btn-sm btn-block" href="<?= base_url('leader/permintaan/terima/' . $dd->id) ?>"><i class="fa fa-paper-plane"></i> Proses</a>
                  <?php } else { ?>
                    <a class="btn btn-primary btn-sm btn-block" href="<?= base_url('leader/permintaan/detail/' . $dd->id) ?>"><i class="fa fa-eye"></i> Detail</a>
                  <?php } ?>
                </div>
              <?php endforeach; ?>
            </div>
