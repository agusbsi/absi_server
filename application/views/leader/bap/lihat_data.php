      ...
      <div class="col-12">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title"> <li class="fas fa-envelope"></li> Data B.A.P</h3>
          </div>
          <!-- /.card-header -->
          <div class="card-body">
            <table id="table_minta" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td><?= kategori_bap($dd->kategori) ?></td>
                ...
                <td>
                  <?php
                  if ($dd->status == 0) {?>
                  <a type="button" class="btn btn-success btn-sm"  href="<?=base_url('leader/Bap/detail_p/'.$dd->id)?>" name="btn_detail" ><i class="fa fa-check" aria-hidden="true"></i> Proses</a>
                <?php }else { ?>
