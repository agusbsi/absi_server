  ...
  <div class="container-fluid">
    ...
    <div class="card card-success card-outline hasil d-none">
      ...
      <div class="card-footer">
        ...
        <a href="<?= base_url('leader/Penjualan/lap_artikel') ?>" class="btn btn-danger btn-sm float-right mr-1"><i class="fa fa-times-circle"></i> close</a>
...
<script>
  ...
  document.getElementById('searchBtn').addEventListener('click', function() {
    ...
    const url = '<?= base_url('leader/Penjualan') ?>';
    if (validateForm()) {
