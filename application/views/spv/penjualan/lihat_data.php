              ...
              <div class="card-body">
                <table id="table_jual" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?=$dd->tanggal_penjualan?></td>
                    <td>
                    <a type="button" class="btn btn-primary"  href="<?=base_url('spv/penjualan/detail_p/'.$dd->id)?>" name="btn_detail" ><i class="fa fa-eye" aria-hidden="true"></i> Detail</a>
                    </td>
