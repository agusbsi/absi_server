             ...
             <div class="card card-info">
               <div class="card-header">
                 ...
                 <div class="card-tools">
                   <a href="<?= base_url('spv/Customer') ?>" type="button" class="btn btn-tool">
                         ...
                         <?php
                          ...
                          ?>
                           <tr>
                             ...
                             <td>
                               <small>
                                 <strong><a href="<?= base_url('spv/toko/profil/' . $toko->id) ?>"><?= $toko->nama_toko ?></a></strong> <br>
                                 Alamat : <br>
                                 <?= $toko->alamat ?>
                               </small>
                             </td>
                             ...
                             <td>
                               <small>
                                 <strong>Leader :</strong> <?= $toko->leader ?> <br>
                                 <strong>SPG :</strong> <?= $toko->spg ?>
                               </small>
                             </td>
                             <td class="text-center">
