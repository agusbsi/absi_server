        ...
        <div class="card card-info">
          <div class="card-header">
            ...
            <div class="card-body">
              ...
              <form action="<?= base_url('sup/aset/list_aset') ?>" method="get">
                ...
                <?php }else if($query != null){ ?>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>
                        <a type="button" class="btn btn-danger btn-hapus"  href="<?=base_url('sup/aset/hapus/'.$row->id)?>" title="Hapus Data"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      </td>                      
                    </tr>
                    <?php } ?>
                    </tbody>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="<?= base_url('sup/aset/tambah_aset_toko') ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
