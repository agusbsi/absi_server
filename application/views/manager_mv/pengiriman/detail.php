        ...
        <div class="invoice p-3 mb-3">
          <div class="row">
            ...
            <div class="col-1 pull-right">
                <a href="<?= base_url('sup/Pengiriman') ?>" class="btn btn-danger"><i class="fas fa-times"></i></a>
            </div>
          ...
          <hr>
            <div class="row invoice-info">
                <div class="col-sm-4 invoice-col">
                    ...
                    <h5>No. Permintaan : <strong><a href="<?= base_url('sup/permintaan/detail/'.$Pengiriman->id_permintaan) ?>"> <?= $Pengiriman->id_permintaan ?> </a></strong></h5>
                    <address>
            ...
            <form method="POST" action="<?= base_url('sup/Pengiriman/approve') ?>">
