<section class="content">
  <div class="container-fluid">
    <div class="card card-default">
      <form action="<?= base_url('sup/Mutasi/proses_simpan') ?>" method="post" id="form_mutasi">
        ...
        <div class="card-footer">
          <?php if ($mutasi->status == 0) { ?>
            <div class="col-12">
              <a href="<?= base_url('sup/Mutasi') ?>" class="btn btn-danger float-right btn-sm" style="margin-left: 5px;"><i class="fas fa-times-circle"></i> Close </a>
  ...
  $('.btn-delete').click(function(e) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        $.ajax({
          url: "<?= base_url() ?>sup/Mutasi/hapus_item",
          method: "POST",
          data: {
            id: id
          },
