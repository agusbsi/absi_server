               ...
               <table id="example1" class="table table-bordered table-striped table-responsive">
                 <thead>
                   <tr>
                     ...
                     <th style="width:20%">Kode Retur</th>
                     <th>Status</th>
                     <th>Nama Toko</th>
                     <th>Nama SPG</th>
                     <th>Tgl</th>
                        ...
                        foreach ($list_data as $data) :
                         ...
                         <td>
                           <?php
                            if ($data->status == 1) {
                            ?>
                             <a type="button" class="btn btn-success btn-sm" href="<?= base_url('sup/retur/detail/' . $data->id) ?>" name="btn_proses"><i class="fas fa-link" aria-hidden="true"></i> Proses</a>
                           <?php } else { ?>
