                  ...
                  <tbody>
                    <tr>
                      ...
                      <?php foreach($list_data as $dd): ?>
                        ...
                        <td>
                            <?php if ($dd->status == 0){ ?>
                            <a href="<?= base_url('staff_ga/aset/approve/'.$dd->id) ?>" class="btn btn-success"><i class="fas fa-check"></i> Approve</a>
                          <?php }else{ ?>
                        ...
                        - 
                        <a type="button" class="btn btn-primary"  href="<?=base_url('staff_ga/aset/detail/'.$dd->id)?>" title="Hapus Data"  ><i class="fa fa-eye"></i> Detail</a>
                        <?php } ?>
                        </td>
                    </tr>
                      <?php $no++; ?>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- isi konten -->
              <form method="POST" action="<?= base_url('staff_ga/aset/proses_tambah')?>" role="form" method="post" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- isi konten -->
              <form method="POST" action="<?= base_url('staff_ga/aset/proses_update')?>" role="form" method="post" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="nik" > <li class="fas fa-id-card"></li> ID Aset</label>
