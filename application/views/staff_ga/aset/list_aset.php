    ...
    <div class="row">
      <div class="col-md-3">
        <div class="card card-info">
            ...
            <div class="card-body">
              <form action="<?= base_url('staff_ga/aset/list_aset') ?>" method="get">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                       <form action="<?= base_url('staff_ga/aset/tambah_aset_toko') ?>" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                ...
                <div class="modal fade" id="Modal_Edit_Aset"  aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                       <form action="<?= base_url('staff_ga/aset/edit_aset_toko') ?>" method="post" enctype="multipart/form-data">
                          <div class="form-group">
                            <label>List Nama Aset</label>
