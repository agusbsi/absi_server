    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-info">
          ...
          <div class="card-body">
            <form action="<?= base_url('adm/Permintaan') ?>" method="post" id="form_cari">
              <div class="row">
                <div class="col-md-5">
              ...
              <tbody>
                ...
                foreach ($list as $row) {
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a class="btn btn-primary btn-sm" href="<?= base_url('adm/Permintaan/detail/') . $row->id ?>"><i class="fa fa-eye" aria-hidden="true"></i> Detail</a></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
