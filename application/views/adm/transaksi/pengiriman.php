    ...
    <div class="row">
      <div class="col-12">
        <div class="card card-info">
          ...
          <div class="card-body">
            <form action="<?= base_url('adm/Pengiriman') ?>" method="post" id="form_cari">
              <div class="row">
                <div class="col-md-5">
                ...
                <div class="col-md-3">
                  ...
                  <?php if (!empty($tgl || $kat)) { ?>
                    <a href="<?= base_url('adm/Pengiriman') ?>" class="btn btn-sm btn-danger mt-2"><i class="fas fa-times-circle"></i> Reset</a>
                  <?php } else { ?>
              ...
              <tbody>
                ...
                foreach ($list as $row) {
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a class="btn btn-primary btn-sm" href="<?= base_url('adm/Pengiriman/detail/') . $row->id ?>"><i class="fa fa-eye" aria-hidden="true"></i> Detail</a></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
