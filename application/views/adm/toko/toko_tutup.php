              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('adm/Toko/toko_tutup_d/' . $t->id) ?>" class="btn btn-sm btn-<?= ($t->status == 12 ? "success" : "info") ?>"> <?= ($t->status == 12 ? "Proses <i class='fa fa-arrow-right'></i>" : "<i class='fa fa-eye'></i> Detail") ?></a>
                    </td>
                  </tr>
                <?php endforeach ?>
              </tbody>
