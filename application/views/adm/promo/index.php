          ...
          <div class="col-12">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title"> <i class="fas fa-cube"></i> Data Promo Baru</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <i class="fas fa-info"></i> Info : <br>
                <address>* Promo Baru yang belum di Approve secara default = "Belum Aktif" dan tidak bisa untuk transaksi.</address>
                <table id ="table_artikel" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    $no++; ?>
                        ...
                        <td>
                      <?php if ($dd->status == 0 ) { ?>
                        <a href="<?= base_url('adm/promo/Approve/'.$dd->id) ?>" class="btn btn-success"><li class="fas fa-times-circle"></li> Approve</a>
                        <a href="<?= base_url('adm/promo/reject/'.$dd->id) ?>" class="btn btn-danger"><li class="fas fa-times-circle"></li> reject</a>
                        <a href="<?= base_url('adm/promo/detail/'.$dd->id) ?>"  class="btn btn-primary"><li class="fas fa-eye"></li> Detail</a>
                      <?php }else{ ?>
                        <a href="<?= base_url('adm/promo/detail/'.$dd->id) ?>"  class="btn btn-primary"><li class="fas fa-eye"></li> Detail</a>
                      <?php } ?>
                        </td>
