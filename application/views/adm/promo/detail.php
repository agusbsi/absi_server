		...
		<div class="row">
			<div class="col-md-12">
				<div class="card-tools float-right">
					<a href="<?= base_url('adm/promo'); ?>" type="button" class="btn btn-tool"><i class="fas fa-times"></i></a>
				</div>
			...
			<div class="row">
				<div class="col-12 table-responsive">
					...
					<div class="row float-right">
						<a href="<?= base_url('adm/promo'); ?>" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Kembali</a>
					</div>
				</div>
			</div>
		</div>
