  ...
  <div class="container-fluid">
    <div class="card card-info card-outline cari">
      <div class="card-header">
        <h3 class="card-title">
          <li class="fas fa-cart-plus"></li> Days Sales of Inventory
        </h3>
      </div>
      <div class="card-body">
        <div class="row">
    ...
    <div class="card card-success card-outline hasil d-none">
      <div class="card-body">
        <div id="printableArea">
          <div class="text-center"> <strong>- Laporan Penjualan Per Toko -</strong> <br>
            <small>Days Sales of Inventory</small>
          </div>
          <hr>
      ...
      <div class="card-footer">
        ...
        <a href="<?= base_url('adm/Analist/dsi') ?>" class="btn btn-danger btn-sm float-right mr-1"><i class="fa fa-times-circle"></i> close</a>
      </div>
    </div>
  </div>
  </div>
