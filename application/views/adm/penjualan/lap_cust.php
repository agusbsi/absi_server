  ...
  <div class="container-fluid">
    <div class="card card-info card-outline cari">
      <div class="card-header">
        <h3 class="card-title">
          <li class="fas fa-cart-plus"></li> Laporan Penjualan per Customer
        </h3>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <select name="id_cust" class="form-control form-control-sm select2" id="id_cust" required>
                <option value="">- Pilih Customer -</option>
                <?php foreach ($cust as $t) : ?>
    ...
    <div class="card card-success card-outline hasil d-none">
      <div class="card-body">
        <div id="printableArea">
          <div class="text-center"> <strong>- Laporan Penjualan Per Customer -</strong></div>
          <hr>
          <p class="text-center" id="cust"></p>
      ...
      <div class="card-footer">
        ...
        <a href="<?= base_url('adm/Penjualan/lap_cust') ?>" class="btn btn-danger btn-sm float-right mr-1"><i class="fa fa-times-circle"></i> close</a>
      </div>
    </div>
  </div>
  </div>
...
<script>
  ...
  function downloadExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Data Penjualan per Customer');
    var filename = 'Laporan_jual_Customer.xlsx';
  ...
  document.getElementById('searchBtn').addEventListener('click', function() {
    var idCust = document.getElementById('id_cust').value;
    ...
    if (validateForm()) {
      ...
      fetch(`${url}/cari_cust?id_cust=${idCust}&tgl_awal=${tglAwal}&tgl_akhir=${tglAkhir}`)
