              ...
              <?php } ?> 
                ...
                <div class="card-body">
                  ...
                  <hr>
                    ...
                    <!-- <div class="text-center">
                    <a type="button" class="btn btn-info btn-block"  href="<?=base_url('toko/update/'.$detail->id)?>" name="btn_update" ><i class="fas fa-edit" aria-hidden="true"></i> Update Toko</a> 
                    </div> -->
                </div>
                              ...
                              <?php foreach($spv_toko as $dd): ?>
                                ...
                                <td> 
                                  <div class="user-block">
                                    ...
                                    <span class="description"><?=$dd->no_telp?></span>
                                  </div>
                                </td>
                          ...
                          <tr>
                              ...
                              <?php foreach($leader_toko as $l): ?>
                                <td> 
                                  ...
                                  <span class="description"><?=$l->no_telp?></span>
                                  </div>
                                </td>
                            ...
                            <td><?= $stok->kode ?></td>
                              ...
                              <td class="text-center">
                                ...
                                if($stok->status == 2){
                                 ...
                                 echo "Rp. "; echo number_format($stok->harga) ; echo " ,-";
                                }
                                ?>
                            </td>
                        </tr>
