                  ...
                  <tbody>
                    <tr>
                      ...
                      <?php if ($dd->nama_user == "")
                        ...
                        <td>
                          <a href="<?= base_url('adm/so/pdf/'.$dd->id) ?>" target = "_blank" class="btn btn-warning btn-sm <?= ($dd->nama_user == "") ? 'd-none' : ''; ?> <?= ($dd->status_so == "1") ? 'd-none' : ''; ?>"><i class="fas fa-file-pdf"></i> Format SO</a>
                          <a href="<?= base_url('adm/so/detail/'.$dd->id) ?>"  class="btn btn-success btn-sm <?= ($dd->nama_user == "") ? 'd-none' : ''; ?> <?= ($dd->status_so == "0") ? 'd-none' : ''; ?>"><i class="fas fa-file-pdf"></i> PROSES SO</a>
                        </td>
                    </tr>
                      <?php $no++; ?>
                      <?php endforeach;?>
