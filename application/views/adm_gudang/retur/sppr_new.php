            ...
            <table>
              <tr>
                <td rowspan="4" class="text-center" style="width:15%;">
                  <img style="width: 60%" src="<?= base_url('assets/img/' . $logo) ?>" alt="logo">
                </td>
            ...
            <div class="row">
              <div class="col-12 table-responsive">
                <table style="border: 2px solid;">
                  ...
                  <tbody>
                    <tr>
                      <td colspan="7" class="text-center"><b>KETERANGAN</b></td>
                    </tr>
                ...
                <div class="row text-center">
                  <div class="col-md-2">
                    ...
                    <div class="signature-placeholder">
                      <?php if (!empty($r->ttd_leader)) { ?>
                        <img src="<?= base_url('assets/img/ttd/' . $r->ttd_leader) . '?t=' . time(); ?>">
                      <?php } ?>
                      <div class="signature-name"><?= $r->leader ?></div>
                      <div class="signature-title">Leader</div>
                    </div>
                  </div>
                  <div class="col-md-4">
