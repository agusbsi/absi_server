    ...
    <div id="printableArea">
      <div class="row">
        <div class="col-md-12">
          ...
          <!-- print area -->
          <form action="<?= base_url('mng_ops/Mutasi/setujuiBap') ?>" method="POST">
            <!-- Main content -->
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="<?= base_url('mng_ops/Mutasi') ?>" class="btn btn-danger btn-sm float-right"> <i class="fas fa-arrow-left"></i> Kembali</a>
