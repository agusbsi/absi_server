        ...
        <div id="printableArea">
          <div class="invoice p-3 mb-3">
            ...
            <?php if ($retur->status == 1) { ?>
              <form action="<?= base_url('mng_ops/Retur/tindakan') ?>" method="post" id="form_approve">
                ...
                <textarea name="catatan_opr" rows="3" class="form-control form-control-sm" required></textarea>
                ...
                <div class="text-right">
                  ...
                  <a href="<?= base_url('mng_ops/Retur') ?>" class="btn btn-sm btn-danger"><i class="fas fa-arrow-left"></i> Kembali</a>
                </div>
              </form>
              <hr>
            <?php } else { ?>
              <div class="row no-print">
                <div class="col-12">
                  <a href="<?= base_url('mng_ops/Retur') ?>" class="btn btn-sm btn-danger float-right" style="margin-right: 5px;">
