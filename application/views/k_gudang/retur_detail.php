...
<section class="content">
  <div class="container-fluid">
    <div class="card card-primary">
      ...
      <div class="card-body">
        <hr>
        <h5 class="text-center">RETUR ARTIKEL DARI SPG</h5>
        <hr>
        <div class="row">
          <div class="col-md-2">
        ...
        <?php if ($retur->status == 3) { ?>
          <form action="<?= base_url('k_gudang/Dashboard/retur_simpan') ?>" method="post" id="form_approve">
            <input type="hidden" name="id_retur" value="<?= $retur->id ?>">
            <input type="hidden" name="jenis" value="retur_spg">
            <div class="form-group">
        ...
        <?php } else { ?>
          <div class="row no-print">
            <div class="col-12">
              ...
              <a class="btn btn-default btn-sm float-right mr-2 <?= $retur->status == 7 || $retur->status == 14 ? '' : 'disabled' ?>" target="_blank" href="<?= base_url('adm_gudang/retur/sppr/' . $retur->id) ?>"><i class="fas fa-print"></i> Sppr</a>
            </div>
          </div>
        <?php } ?>
      </div>
