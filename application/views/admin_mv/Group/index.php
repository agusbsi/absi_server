          ...
          <div class="card-body">
            <div class="tab-content" id="custom-tabs-two-tabContent">
              ...
              <div class="tab-pane fade show active" id="kelola_grup" role="tabpanel">
                <form action="<?= base_url('adm_mv/group') ?>" method="get" class="form-horizontal">
                ...
                <?php }else if($query != null){ ?>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <td>
                        <a type="button" class="btn btn-danger btn-hapus"  href="<?=base_url('adm_mv/group/hapus/'.$row->id)?>" title="Hapus Data"><i class="fa fa-trash" aria-hidden="true"></i></a>
                      </td>                      
                    </tr>
                    <?php } ?>
                    </tbody>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="<?= base_url('adm_mv/group/tambah_toko') ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
