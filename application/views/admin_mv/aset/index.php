     ...
     <section class="content">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <?php foreach($list_data as $dd): ?>
                        ...
                        - 
                        <a type="button" class="btn btn-danger btn-hapus"  href="<?=base_url('adm_mv/aset/hapus/'.$dd->id)?>" title="Hapus Data"  ><i class="fa fa-trash" aria-hidden="true"></i></a>
                        </td>
                    </tr>
                      <?php $no++; ?>
                      <?php endforeach;?>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <!-- isi konten -->
                    <form method="POST" action="<?= base_url('adm_mv/aset/proses_tambah')?>">
      ...
      <!-- modal edit data -->
      <!-- Modal Edit Product-->
    <form action="<?= base_url('adm_mv/aset/proses_update')?>" method="POST">
