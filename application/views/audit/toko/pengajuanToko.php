              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url('audit/Toko/detail/' . $t->id) ?>" class="btn btn-<?= $t->status == 3 ? "success" : "info" ?> btn-sm "> <i class="fas fa-<?= $t->status == 3 ? "arrow-right" : "eye" ?>"></i> <?= $t->status == 3 ? "Proses" : "Detail" ?> </a>
                    </td>
                  </tr>
                <?php endforeach ?>
              </tbody>
