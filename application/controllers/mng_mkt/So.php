...
class So extends CI_Controller {
  ...
  public function index()
  {
    ...
    $this->template->load('template/template', 'manager_mkt/stokopname/index', $data);
  }
  ...
  public function detail()
  {
    ...
    $this->template->load('template/template', 'manager_mkt/stokopname/detail',$data);
  }
  ...
  public function detail_so($no_so)
  {
   ...
   $this->load->view('manager_mkt/stokopname/detail_print_so',$data);
  }
  // download pdf
  public function pdf($toko)
    {
        ...
        where ts.id_toko = '$toko' and ts.qty != '0'")->result();
		    $html = $this->load->view('manager_mkt/stokopname/print_so',$data, true);	 
        // run dompdf
  ...
  public function hasil_so($toko)
  {
    ...
    // so terbaru
      ...
      $html = $this->load->view('manager_mkt/stokopname/print_hasil_so',$data, true);	 
      // run dompdf
      $this->pdfgenerator->generate($html, $file_pdf,$paper,$orientation);
  }
