...
class Mutasi extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data['list_data'] = $this->db->query("SELECT tm.*, tt.nama_toko as asal, tk.nama_toko as tujuan 
                                            ...
                                            ORDER BY tm.status = 6 DESC, tm.id DESC")->result();
    $this->template->load('template/template', 'manager_mkt/mutasi/lihat_data', $data);
  }
  public function bap($id)
  {
    ...
    $this->template->load('template/template', 'manager_mkt/mutasi/bap', $data);
  }
  public function detail($mutasi)
  {
    ...
    $this->template->load('template/template', 'manager_mkt/mutasi/detail', $data);
  }
  ...
  function proses_simpan()
  {
    ...
    redirect(base_url('mng_mkt/Mutasi/detail/' . $id_mutasi));
  }
  // setujui bap
  public function setujuiBap()
  {
    ...
    redirect(base_url('mng_mkt/Mutasi'));
  }
}
