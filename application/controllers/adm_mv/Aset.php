...
class Aset extends CI_Controller {
  ...
  public function index()
  {
    ...
    $data['avatar'] = $this->M_admin->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
      $this->template->load('template/template', 'admin_mv/aset/index', $data);
  }
  ...
  public function proses_update()
  {
    ...
    $this->template->load('template/template', 'admin_mv/aset/list_aset.php', $data);
    }
    ...
    public function tambah_aset_toko()
    {
      ...
      if ($cek_from == TRUE) {
        ...
        if ($cek_aset>0) {
          ...
          redirect('adm_mv/aset/list_aset?id_toko='.$id);
        }else{
    ...
    public function edit_aset_toko()
    {
      ...
      if ($this->form_validation->run() == TRUE) {
        ...
        tampil_alert('success','Berhasil','Data berhasil diupdate !');
        redirect('adm_mv/aset/list_aset?id_toko='.$id_toko);
        }else{
        tampil_alert('erorr','Gagal','Data Gagal diupdate !');
        redirect('adm_mv/aset/list_aset?id_toko='.$id_toko);
        }
